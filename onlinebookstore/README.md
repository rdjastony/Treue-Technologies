...
insert into users values('ashi','ashi','ashi','Raj','MH','1236547089','ashi@gmail.com',2);
...
Step 1. a: Go inside ```src/main/resources > application.properties``` and update the value of database details as per your usage, like db.driver, db.host, db.username and db.password according to your installed mysql/postgresql admin user credentials.
...
Step 8: The default Username And Password For User Is "abhi" And "abhi" or "shashi" "shashi"
